...
void dealHand(unsigned int hand[][FACES], const char *wFace[],
              const char *wSuit[], unsigned int player); // dealing doesn't modify the arrays

void takeHand(unsigned int hand[][FACES], unsigned int wDeck[][FACES], int player);
int pointValue(unsigned int hand[][FACES], unsigned int player);
...
int main(void)
{
    ...
    takeHand(hand, deck,0);
    takeHand(hand2,deck,1);
    ...
    printf("\n%s\n", "First hand");
    dealHand(hand, face, suit,0); // deal the hand

    puts("");

    printf("\n%s\n", "Second hand");
    dealHand(hand2, face, suit,1); // deal the hand

    int point1 = pointValue(hand,0);
    int point2 = pointValue(hand2,1);
    puts("");
    printf("%s%s", "Point for the hand is: ", points[point1]);
    puts("");

    puts("");
    printf("%s%s", "Point for the second hand is: ", points[point2]);
    puts("");

    if(point1 > point2)
    {
    puts("");
    printf("%s", "Player 1 wins this hand!");
    puts("");
    }
    else if(point1 < point2)
    {
    puts("");
    printf("%s", "Player 2 wins this hand!");
    puts("");
    }
    else
    {
...
//take hands for the players
void takeHand(unsigned int hands[][FACES], unsigned int wDeck[][FACES], int player)
{
    unsigned int card = 1+(player * HAND);
    int effectiveHand = HAND+(player * HAND);
    for (size_t i = card; i <= effectiveHand; ++i)
    {
...
// deal cards in deck
void dealHand(unsigned int hand[][FACES], const char *wFace[],
              const char *wSuit[], unsigned int player)
{
    unsigned int card = 1+(player * HAND);
    int effectiveHand = HAND+(player * HAND);
    // deal each of the cards

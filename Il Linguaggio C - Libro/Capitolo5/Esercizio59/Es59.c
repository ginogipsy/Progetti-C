...
int main(void)
{
    ...
    double costoTotale = 0.0;
        ...
        scanf("%lf%lf%lf", &oreParcheggio1, &oreParcheggio2, &oreParcheggio3);
        ...
        printf("%10s%10s%10s:\n", "Car", "Hours", "Charges");
        printf("%10d%10.2f%10.2f\n", 1, oreParcheggio1, costoParcheggio1);
        printf("%10d%10.2f%10.2f\n", 2, oreParcheggio2, costoParcheggio2);
        printf("%10d%10.2f%10.2f\n", 3, oreParcheggio3, costoParcheggio3);
        printf("%10s%10.2f%10.2f\n","TOTAL", oreTotali, costoTotale);
}
